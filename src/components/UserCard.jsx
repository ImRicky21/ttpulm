...
export default function UserCard({position, nidn, username}){
    return(
        ...
        <div className="rounded-xl my-9 mx-4 group">
            <div className="bg-slate-200 flex flex-col border text-center trasition ease-in duration-300 rounded-lg w-64 justify-center hover:shadow-2xl hover:relative hover:scale-110">   
